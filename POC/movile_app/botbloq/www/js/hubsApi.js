...
function HubsAPI(url, serverTimeout, wsClientClass, PromiseClass) {
    ...
    this.TopicsManager = {};
    this.TopicsManager.server = {
        __HUB_NAME: 'TopicsManager',

        classMethod: function () {

            return constructMessage('TopicsManager', 'class_method', arguments);
        },

        publish: function (publisher) {

            return constructMessage('TopicsManager', 'publish', arguments);
        },

        staticFunc: function () {

            return constructMessage('TopicsManager', 'static_func', arguments);
        },

        getSubscribedClientsToHub: function () {

            return constructMessage('TopicsManager', 'get_subscribed_clients_to_hub', arguments);
        },

        subscribeToHub: function () {

            return constructMessage('TopicsManager', 'subscribe_to_hub', arguments);
        },

        unsubscribeFromHub: function () {

            return constructMessage('TopicsManager', 'unsubscribe_from_hub', arguments);
        }
    };
    this.TopicsManager.client = {};
}
/* jshint ignore:end */
/* ignore jslint end */
